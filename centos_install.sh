...
sudo yum install -y python27 python-pip ImageMagick ffmpeg Xvfb dbus-x11 libcgroup libcgroup-tools traceroute tcpdump psmisc python-devel
...
sudo yum -y install google-chrome-stable google-chrome-beta google-chrome-unstable firefox
